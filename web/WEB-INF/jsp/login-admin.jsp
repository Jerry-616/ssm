        ...
        <form id="login1">
            <div class="form-group has-feedback">
                <input type="text" name="adminname" class="form-control"
                       placeholder="管理员名" required> <span
            ...
            <div class="row">
                <div class="col-xs-9">
                    ...
                    <a href="${pageContext.request.contextPath}/user/jumplogin" class="text-center"><b>会员登录</b></a>
                </div>
                <div class="col-xs-3">
                    <button type="button" class="btn btn-primary btn-block btn-flat"
                            onclick="adminlogin()" title="登录">登录</button>
    ...
    function adminlogin(){
        $.ajax({
            ...
            success:function (response) {
                alert("登录成功");
                window.location.href="${pageContext.request.contextPath}/jump/jumpbackindex";
            },
            error:function (){
                alert("管理员名或密码有误！");
            }
